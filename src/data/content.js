...
const ALL_FAQS = [
  ...
  },
  {
    ...
    answer:
      '월 구독은 전 지점 월 48,900원입니다. 여러 GYM PASS 지점을 함께 이용하는 이용권은 이용범위와 가격이 달라 상품 안내에서 확인해 주세요.',
  },
  {
  ...
  /* ── 이용·입장 ── */
  {
    ...
    answer:
      '아닙니다. 짐플릭스 시청점은 짐서폿 앱을 사용하며, 올드짐 평거점과 머슬팩토리24 보건대점·신진주역점·삼천포 본점·삼천포 벌리점·진주강남점·혁신점은 바디코디 앱을 사용합니다. 지점을 선택하시면 해당 지점의 이용방법이 표시됩니다.',
  },
  {
    id: 'store-add',
    category: 'use',
    ...
    answer:
      '네. 회사는 신규 지점 추가, 지점 폐점, 브랜드 변경, 운영형태 변경 또는 기타 운영상 필요한 사유로 구독서비스 이용 가능 지점을 추가하거나 변경할 수 있습니다. 새로운 구독 운영지점이 추가되면 회사가 정한 적용 시점부터 이용할 수 있습니다.',
  },
  {
    id: 'store-close',
    category: 'use',
