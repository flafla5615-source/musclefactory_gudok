...
1. 이 폴더에 실사진을 저장한다.
   ...
   ```
   public/images/mf-jinju-gangnam/
...
2. `src/data/stores.js` 의 `id: 'mf-jinju-gangnam'` 객체에서 아래 두 줄만 채운다.
   컴포넌트는 손댈 필요 없다.
   ...
   facilityImages: [
     ...
     { src: '/images/mf-jinju-gangnam/02.jpg', category: '웨이트존' },
     { src: '/images/mf-jinju-gangnam/03.jpg', category: '머신존' },
     { src: '/images/mf-jinju-gangnam/04.jpg', category: '프리웨이트존' },
     { src: '/images/mf-jinju-gangnam/05.jpg', category: '유산소존' },
   ],
   ```
